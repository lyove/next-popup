...
export default class Popover {
  ...
  #addEnterEvent() {
    ...
    if (enterable && emit === EmitType.Hover) {
      this.originElement.addEventListener("mouseenter", this.#onTriggerEnter);
      this.originElement.addEventListener("mouseleave", this.#onTriggerLeave);
    }
  }

  #removeEnterEvent() {
    this.originElement.removeEventListener("mouseenter", this.#onTriggerEnter);
    this.originElement.removeEventListener("mouseleave", this.#onTriggerLeave);
  }
